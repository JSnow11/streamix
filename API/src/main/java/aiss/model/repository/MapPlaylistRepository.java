...
public class MapPlaylistRepository implements PlaylistRepository{
	...
	public void init() {
		...
		Playlist playlistNoSongs = new Playlist();
		playlistNoSongs.setName("NoSongs");
		playlistNoSongs.setDescription("A playlist without songs");
		addPlaylist(playlistNoSongs);
